...
let myPeople: [String] = ["찬혁", "초희", "지현", "수인", "희준", "카푸", "치노", "연주", "초롱"]
let sortedCollection1 = myPeople.sorted(by: forwards(name1:name2:))
...
let sortedCollection2 = myPeople.sorted(by: { (name1: String, name2: String) in
    return name1 < name2
})
...
let sortedCollection3 = myPeople.sorted(by: <)
