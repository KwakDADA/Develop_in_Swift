...
var strongRope = TreehousePulley(weightCapacity: 3000)
/*:
 - callout(Exercise): 
 ...
 */
ricketyRope.canHandleAdditionalLoad(cup)
ricketyRope.addLoadToBasket(loadWeight: cup)
ricketyRope.canHandleAdditionalLoad(blanket)
strongRope.canHandleAdditionalLoad(blanket)
strongRope.addLoadToBasket(loadWeight: blanket)
strongRope.canHandleAdditionalLoad(iMac)
strongRope.addLoadToBasket(loadWeight: iMac)
/*:
