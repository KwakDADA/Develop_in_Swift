 ...
 */
makePieChart()
pieChartView.wedges.append(PieWedge(proportion: 0.5, color: .red))
pieChartView.wedges.append(PieWedge(proportion: 0.5, color: .blue))
pieChartView.labelDisplayStyle = .none
/*:
