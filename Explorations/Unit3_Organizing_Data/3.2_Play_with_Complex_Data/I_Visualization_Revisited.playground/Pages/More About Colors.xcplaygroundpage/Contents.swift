...
makePieChart()
pieChartView.wedges.append(PieWedge(proportion: 0.3, color: Color(white: 0.55, alpha: 0.3)))
pieChartView.wedges.append(PieWedge(proportion: 0.4, color: Color(hue: 0.53, saturation: 0.23, brightness: 0.77)))
...
addWedge(withProportion: 0.35, color: Color(red: 0.2, green: 0.4, blue: 0.63, alpha: 0.5))
addKeyItem(withLabel: "nemo", color: Color(white: 0.55, alpha: 0.3))
/*:
