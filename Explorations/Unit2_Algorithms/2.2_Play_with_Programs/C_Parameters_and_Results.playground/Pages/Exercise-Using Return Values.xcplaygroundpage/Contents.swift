 ...
 */
let impossible = impossibleBeliefsCount(pigsFlying: 1, frogsBecomingPrinces: 1, multipleLightningStrikes: 0)
impossibleThingsPhrase(numberOfImpossibleThings: impossible, meal: "dinner")
/*:
