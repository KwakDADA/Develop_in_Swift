...
let favoriteFood = makeFavorite(categoryOfThing: "food", favorite: "burger")
let favoriteMovie = makeFavorite(categoryOfThing: "movie", favorite: "Vanilla Sky")
let favoriteSchoolSubject = makeFavorite(categoryOfThing: "school subject", favorite: "physics")
let favoriteBand = makeFavorite(categoryOfThing: "band", favorite: "Red Hot Chili Peppers")
/*:
 ...
 */
"Hello, my name is Daeun. \(favoriteFood). \(favoriteMovie). \(favoriteSchoolSubject). \(favoriteBand)."
/*:
