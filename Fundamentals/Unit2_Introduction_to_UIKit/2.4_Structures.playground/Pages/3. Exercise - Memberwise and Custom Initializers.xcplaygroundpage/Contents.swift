...
let favoriteBook = Book(title: "The Beatles Anthology", author: "The Beatles", pages: 368, price: 98000)
/*:
...
let MacBook1 = Laptop(yearPurchased: 2020)
let MacBook2 = Laptop(screenSize: 15, repairCount: 0, yearPurchased: 2024)
/*:
...
var myHeight = Height(centimeters: 177.7)
