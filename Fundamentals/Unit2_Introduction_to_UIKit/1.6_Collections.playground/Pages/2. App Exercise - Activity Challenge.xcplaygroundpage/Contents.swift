 ...
 */
var walkingChallenges = ["Walk 3 miles a day", "Walk 5 miles a day"]
var runningChallenges = ["Run 5 times a week", "Run 20 minutes"]
...
print(challenges[0], challenges[1])
...
if committed.isEmpty {
    ...
    print("The challenge you have chosen is \(committed).")
} else {
