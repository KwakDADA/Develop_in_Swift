...
favoriteBook.title = "Cosmos"
favoriteBook.author = "Carl Sagan"
favoriteBook.pages = 694
favoriteBook.price = 49000
print("My favorite book is \(favoriteBook.title), written by \(favoriteBook.author). This book has \(favoriteBook.pages), and the price is \(favoriteBook.price) won.")
/*:
