...
// x is defined in both of global and local.
// local x's value is modified.
// foo is defined in local scope, and used in local and global(if the line 10 were uncomment).
...
greeting(greeting: "Hi there", name: "Daeun")
greeting(greeting: nil, name: "Chanhyeok")
